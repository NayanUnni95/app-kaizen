                ...
                <div className="space-y-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <h1 className="font-heading font-black text-4xl text-white tracking-tighter leading-none uppercase">Squad Identity</h1>
            ...
            <section className="kz-card-rich p-10 kz-animate-slide-up bg-white/[0.02] border-white/5 group overflow-hidden" style={{ animationDelay: "100ms" }}>
                <div className="flex flex-col md:flex-row md:items-center gap-10 relative z-10">
                    ...
                    <div className="relative shrink-0">
                        <div className="w-28 h-28 rounded-2xl flex items-center justify-center text-4xl font-heading font-bold text-white border border-white/10 bg-slate-900 overflow-hidden">
                    ...
                    <div className="flex-1 space-y-4">
                        <div className="space-y-1">
                            <div className="flex flex-wrap items-center gap-3">
                                <h2 className="font-heading font-black text-3xl text-white tracking-tighter uppercase">{team.name}</h2>
                        ...
                        <div className="flex flex-wrap gap-4 pt-6 mt-6 border-t border-white/5">
                            <div className="px-3 py-1.5 rounded-lg bg-white/5 border border-white/5 flex items-center gap-2.5 group/meta">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[10px] font-bold text-white uppercase tracking-tight">{team.event.name}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="flex flex-col gap-16">
                ...
                <section className="space-y-8 kz-animate-slide-up px-2" style={{ animationDelay: "300ms" }}>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 items-start">
                        {/* Pipeline Content */}
                        <div className="lg:col-span-3 kz-card-rich p-8 bg-white/[0.02] border-white/5">
                            ...
                            <div className="space-y-6 opacity-40 select-none">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="w-full h-12 p-3 rounded-xl border border-white/5 bg-white/5 text-xs font-bold text-slate-700 truncate leading-none flex items-center">
