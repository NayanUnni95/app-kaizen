...
const navItems = [
    ...
    { name: "Checkpoints", href: "/organizer/checkpoints", icon: CheckSquare },
    ...
    return (
        <aside className="w-64 h-screen bg-zinc-950 border-r border-white/5 flex flex-col fixed left-0 top-0 z-50">
            <div className="p-8 flex items-center gap-3">
                <div className="w-8 h-8 bg-teal-600 rounded-lg flex items-center justify-center font-black italic shadow-lg shadow-teal-500/20">
                    O
                </div>
                <span className="font-bold tracking-tight text-white">Organizer Hub</span>
            </div>
