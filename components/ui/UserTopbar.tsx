            ...
            <div className="max-w-[1600px] mx-auto px-8 lg:px-12 h-16 flex items-center justify-between gap-8">
                ...
                <div className="flex items-center gap-3 sm:gap-6 min-w-0 flex-1">
                    <Link href="/team" className="flex items-center gap-2 sm:gap-3 min-w-0 group">
                        <div className="relative flex items-center">
                            ...
                            <div className="w-8 h-8 -ml-3 rounded-lg border-2 border-[#0B0E14] ring-2 ring-indigo-500/20 bg-slate-900 overflow-hidden shrink-0 group-hover:translate-x-1 transition-transform sm:block hidden">
                    ...
                    <div className="h-5 w-[1px] bg-white/5 hidden lg:block" />
                ...
                <div className="flex items-center gap-2 sm:gap-4 ml-auto">
                    ...
                    <button
                        ...
                        className="relative w-10 h-10 flex items-center justify-center rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 transition-all group"
                        aria-label={`Notifications${unreadCount > 0 ? `, ${unreadCount} unread` : ""}`}
                    >
                        <Bell
                            className="w-4.5 h-4.5 text-slate-500 group-hover:text-white transition-colors"
                            strokeWidth={2}
                        />
                        {unreadCount > 0 && (
                            <span className="absolute top-2.5 right-2.5 w-2.5 h-2.5 bg-indigo-500 rounded-full border-2 border-[#0B0E14]" />
                        )}
                    </button>
                    ...
                    <div ref={profileRef} className="relative">
                        <button
                            ...
                            className="flex items-center gap-2.5 pl-1.5 pr-2.5 py-1.5 rounded-xl border border-white/5 bg-white/5 hover:bg-white/10 transition-all group"
                            aria-haspopup="true"
                            aria-expanded={profileOpen}
                        >
                            <div className="relative">
                                <Avatar name={teamName} size="sm" className="w-7 h-7 ring-2 ring-white/10" />
                                <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-emerald-500 rounded-full border-2 border-[#0B0E14]" />
                            </div>
                            <div className="hidden sm:flex flex-col items-start min-w-0">
                                <span className="text-[12px] font-bold text-white truncate max-w-[100px] leading-none mb-0.5">{teamName}</span>
                            ...
                            <div className="absolute top-14 right-0 w-64 kz-card-rich p-2 kz-animate-scale-in origin-top-right z-50 border-white/10">
                                ...
                                <div className="space-y-1">
                                    <Link
                                        ...
                                        className="flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-white/5 text-[12px] font-bold text-slate-300 transition-all group"
                                    >
                                        <div className="flex items-center gap-3">
                                            <div className="w-8 h-8 rounded-lg bg-white/5 border border-white/5 flex items-center justify-center text-slate-500 group-hover:text-indigo-400 transition-colors">
                                    ...
                                    >
                                        <div className="w-8 h-8 rounded-lg bg-white/5 border border-rose-500/20 flex items-center justify-center text-rose-500/50 group-hover:text-rose-500 transition-colors">
