        ...
        <div className="space-y-16 pb-24 pt-6 kz-mesh-bg min-h-screen">
            ...
            <section className="kz-animate-fade-in flex flex-col md:flex-row md:items-start justify-between gap-12 px-2">
                <div className="space-y-4">
                    ...
                    <h1 className="font-heading text-3xl md:text-3xl text-slate-900 dark:text-white tracking-tight leading-tight py-2">
                        Welcome Back,<br />
                        <span className="text-slate-900 dark:text-white inline-block mt-2 text-4xl md:text-5xl font-semibold">{team.name}</span>
                    </h1>
                    <div className="flex items-center gap-6 pt-4 border-t border-white/5 bg-white/[0.01] rounded-b-xl px-4 py-3">
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1">Total Competition</span>
                            <div className="flex items-center gap-2">
                                <span className="text-xl font-mono-tech text-slate-900 dark:text-white leading-none">{allTeams - 1}</span>
                                <span className="text-[10px] font-bold text-slate-600 dark:text-slate-500 uppercase tracking-widest">Units Active</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-3">
                            {[1, 2, 3].map(i => (
                                <div key={i} className="flex items-center justify-between">
                                    ...
                                    <span className="text-[10px] font-mono-tech font-bold text-slate-500 dark:text-slate-400 uppercase">stable_v{i}.0</span>
                                </div>
                            ))}
                        </div>
                    </div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-2">
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-2 kz-card-rich p-10 flex flex-col justify-between group overflow-hidden border-white/5 bg-white/[0.02]">
                    <div>
                        <div className="flex items-center gap-4 mb-10">
                            <div className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 flex items-center justify-center text-slate-400 dark:text-slate-600">
                                <Clock className="w-5 h-5" strokeWidth={1.5} />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-[10px] font-bold text-slate-900/40 uppercase tracking-[0.2em] leading-none">Event Timer</span>
                                <span className="text-[9px] text-slate-500 font-bold mt-1 uppercase tracking-widest">Status: Operational</span>
                            </div>
                        </div>
                        <div className="font-mono-tech text-4xl sm:text-5xl lg:text-7xl text-slate-900 tracking-widest leading-none mb-8 font-bold">
                    ...
                    <div className="mt-auto">
                        <div className="flex items-center justify-between mb-4 px-1">
                            <div className="flex items-center gap-2.5">
                                ...
                                <span className="text-[10px] font-mono-tech font-bold text-slate-900 dark:text-white uppercase tracking-[0.2em]">PROG: {progressPct}%</span>
                            </div>
                            <span className="text-[9px] font-mono-tech font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">SYSTEM_LOAD: 0.82</span>
                        </div>
                ...
                <div className="col-span-1 flex flex-col gap-6">
                    ...
                    <Link href="/team/checkpoints" className="kz-card-rich p-8 flex flex-col group transition-all duration-500 hover:bg-white/[0.04] border-white/5 bg-white/[0.02] block h-full">
                        <div className="flex items-center gap-4 mb-10">
                            <div className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 flex items-center justify-center text-indigo-400 group-hover:bg-indigo-600 transition-all duration-500">
                                <ListChecks className="w-5 h-5" strokeWidth={1.5} />
                            </div>
                            <div className="flex flex-col">
                                <span className="text-[10px] font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest leading-none">Milestones</span>
                        ...
                        <div className="mt-auto space-y-4">
                            ...
                            <span className="text-[9px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em]">Verification Active</span>
                        </div>
                    </Link>
                </div>
                        ...
                        <div className="mt-auto space-y-8">
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    <h3 className="font-heading font-black text-slate-900 dark:text-white text-2xl uppercase tracking-tighter">Team Identity</h3>
                                    <span className="text-[9px] font-mono-tech font-black text-emerald-600 dark:text-emerald-400 px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/20 uppercase tracking-widest">Secure</span>
                                </div>
                                <p className="text-[10px] text-slate-600 dark:text-slate-400 font-mono-tech font-bold uppercase tracking-[0.3em]">@ Ops_Ready</p>
                            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 px-2">
                    ...
                    <div className="space-y-3">
                        {announcements.length === 0 ? (
                            ...
                            announcements.map((a: any) => (
                                ...
                                >
                                    <div className="kz-icon-rich w-12 h-12 bg-black/5 dark:bg-white/5 border-black/5 dark:border-white/5 text-slate-400 dark:text-slate-600 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors shrink-0">
                                        <Bell className="w-5 h-5 relative z-10" />
                                    </div>
                                    <div className="flex-1 min-w-0 pt-1">
                                        <div className="flex items-center justify-between gap-4 mb-2">
                                            <div className="flex items-center gap-3">
                                                <h3 className="font-heading font-black text-lg text-slate-900 dark:text-white tracking-tight">
                                                    {a.title}
                                                </h3>
                                                <div className="w-1.5 h-1.5 rounded-full bg-indigo-600 dark:bg-indigo-400 shadow-[0_0_8px_rgba(99,102,241,0.5)]" />
                                            </div>
                                            <span className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest whitespace-nowrap bg-black/5 dark:bg-white/5 px-2 py-1 rounded-md border border-black/5 dark:border-white/5">
                                                {new Date(a.createdAt).toLocaleDateString(undefined, { month: 'short', day: 'numeric' })}
                                            </span>
                                        </div>
                                        {a.body && (
                                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed font-semibold opacity-80 group-hover:opacity-100 transition-opacity">
                                                {a.body}
                                            </p>
                                        )}
                ...
                <div className="space-y-10">
                    ...
                    <div className="flex flex-col gap-4">
                            ...
                            <Link key={i} href={item.href} className="group relative">
                                <div className="kz-card-rich p-6 flex items-center gap-5 bg-white/[0.02] border-white/5 hover:border-indigo-500/30 hover:scale-[1.02] transition-all duration-500 active:scale-95">
                                    ...
                                    <div className="flex flex-col min-w-0">
                                        ...
                                        <span className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest mt-1.5">{item.desc}</span>
                                    </div>
                        ...
                        >
                            <div className="kz-card-rich p-6 flex items-center gap-5 bg-indigo-600/10 hover:bg-indigo-600/20 hover:scale-[1.02] transition-all duration-500 active:scale-95 border-indigo-500/20">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <span className="font-heading font-black text-lg text-slate-900 dark:text-white leading-none uppercase tracking-tight">Notifications</span>
                    ...
                    {/* Section Info Badge */}
                    <div className="kz-card-rich p-6 border-dashed border-2 border-black/5 dark:border-white/10 flex items-center gap-4 bg-black/[0.01] dark:bg-white/[0.01]">
                        <Shield className="w-8 h-8 text-slate-400 dark:text-slate-600" />
                        <div className="flex flex-col">
                            <span className="text-[10px] font-black text-slate-500 dark:text-slate-600 uppercase tracking-widest">Active Session</span>
                            <p className="text-[11px] text-slate-600 dark:text-slate-500 font-bold leading-tight">Your connection is secure and verified for this event session.</p>
                        </div>
                    </div>
                </div>
            </div>
